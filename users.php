        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                <?php foreach ($users as $user): ?>
                    <div class="col-xl-4">
                    <div id="c_<?= $user['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user['userName'] ?: "Нет данных" ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?= getUserStatus($user['status']) ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?= $user['image'] ?: "uploads/user.jpg" ?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <strong class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?= $user['userName'] ?: "Нет данных" ?>
                                    </strong>
                                    <?php if (isAdmin(getLoggedUser()) || isEqualUser($user, getLoggedUser())): ?>
                                    ...
                                    <?php endif; ?>
                                    <span class="text-truncate text-truncate-xl"><?= $user['jobTitle'] ?: "Нет данных" ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?= $user['phone'] ?: "#" ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?= $user['phone'] ?: "Нет данных" ?></a>
                                <a href="<?= $user['email'] ?: "#" ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?= $user['email'] ?: "Нет данных" ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?= $user['address'] ?: "Нет данных" ?></address>
                                <div class="d-flex flex-row">
                                    <a href="<?= $user['vk'] ? "https://" . $user['vk'] : "#" ?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="<?= $user['telegram'] ? "https://" . $user['telegram'] : "#" ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?= $user['instagram'] ? "https://" . $user['instagram'] : "#" ?>" class="mr-2 fs-xxl" style="color:#E1306C">
