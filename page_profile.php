...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <?php getFlashMessage('info') ?>
            <?php getFlashMessage('danger') ?>
            <div class="subheader">
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="<?= $user['image'] ?: "uploads/user.jpg" ?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        <?= $user['userName'] ?>
                                        <small class="text-muted mb-0"><?= $user['jobTitle'] ?></small>
                                    </h5>
                                    <div class="mt-4 text-center demo">
                                        <a href="<?= $user['instagram'] ? "https://" . $user['instagram'] : "#" ?>" class="fs-xl" style="color:#C13584">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                        <a href="<?= $user['vk'] ? "https://" . $user['vk'] : "#" ?>" class="fs-xl" style="color:#4680C2">
                                            <i class="fab fa-vk"></i>
                                        </a>
                                        <a href="<?= $user['telegram'] ? "https://" . $user['telegram'] : "#" ?>" class="fs-xl" style="color:#0088cc">
