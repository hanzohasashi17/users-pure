                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="status">
                                                <option <?= $user['status'] === 'online' ? 'selected' : '' ?> value="online">Онлайн</option>
                                                <option <?= $user['status'] === 'moved_away' ? 'selected' : '' ?> value="moved_away">Отошел</option>
                                                <option <?= $user['status'] === 'do_not_disturb' ? 'selected' : '' ?> value="do_not_disturb">Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
